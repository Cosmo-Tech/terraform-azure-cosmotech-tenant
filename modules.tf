...
module "azure-tenant-resources" {
  ...
  platform_sp_object_id   = var.deployment_type != "ARM" ? data.azuread_service_principal.platform.0.object_id : var.platform_sp_object_id
...
module "platform-tenant-resources" {
  ...
  network_adt_clientid      = var.deployment_type != "ARM" ? module.azure-tenant-prerequisites.0.out_network_adt_clientid : var.network_adt_clientid
  ...
  platform_sp_client_id     = var.deployment_type != "ARM" ? module.azure-tenant-prerequisites.0.out_platform_clientid : var.platform_client_id
  platform_sp_client_secret = var.deployment_type != "ARM" ? module.azure-tenant-prerequisites.0.out_platform_sp_client_secret : var.platform_client_secret
