...
| <a name="input_pv_minio_storage_gbi"></a> [pv\_minio\_storage\_gbi](#input\_pv\_minio\_storage\_gbi) | n/a | `string` | n/a | yes |
...
| <a name="input_pv_postgres_storage_gbi"></a> [pv\_postgres\_storage\_gbi](#input\_pv\_postgres\_storage\_gbi) | n/a | `string` | n/a | yes |
...
| <a name="input_pv_redis_storage_gbi"></a> [pv\_redis\_storage\_gbi](#input\_pv\_redis\_storage\_gbi) | n/a | `string` | n/a | yes |
...
| <a name="input_pv_seaweedfs_storage_gbi"></a> [pv\_seaweedfs\_storage\_gbi](#input\_pv\_seaweedfs\_storage\_gbi) | n/a | `string` | n/a | yes |
