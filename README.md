...
| <a name="input_copilot_bot_name"></a> [copilot\_bot\_name](#input\_copilot\_bot\_name) | Name of the Azure Bot. | `string` | n/a | yes |
| <a name="input_copilot_bot_site_name"></a> [copilot\_bot\_site\_name](#input\_copilot\_bot\_site\_name) | Name of the site used for bot channels (e.g., DirectLine, WebChat). | `string` | n/a | yes |
| <a name="input_copilot_bot_sku"></a> [copilot\_bot\_sku](#input\_copilot\_bot\_sku) | SKU of the bot. | `string` | n/a | yes |
| <a name="input_copilot_function_app_name"></a> [copilot\_function\_app\_name](#input\_copilot\_function\_app\_name) | Name of the Linux Function App. | `string` | n/a | yes |
| <a name="input_copilot_function_plan_name"></a> [copilot\_function\_plan\_name](#input\_copilot\_function\_plan\_name) | Name of the App Service Plan for the Function App. | `string` | n/a | yes |
| <a name="input_copilot_function_storage_name"></a> [copilot\_function\_storage\_name](#input\_copilot\_function\_storage\_name) | Name of the Storage Account for the Function App. | `string` | n/a | yes |
...
| <a name="input_copilot_openai_custom_subdomain"></a> [copilot\_openai\_custom\_subdomain](#input\_copilot\_openai\_custom\_subdomain) | Custom subdomain name for the Cognitive Services account. | `string` | n/a | yes |
...
| <a name="input_copilot_openai_name"></a> [copilot\_openai\_name](#input\_copilot\_openai\_name) | Name of the Cognitive Services account for Azure Open AI. | `string` | n/a | yes |
...
| <a name="input_copilot_search_service_name"></a> [copilot\_search\_service\_name](#input\_copilot\_search\_service\_name) | Name of the Azure Search service. | `string` | n/a | yes |
...
| <a name="input_copilot_web_app_name"></a> [copilot\_web\_app\_name](#input\_copilot\_web\_app\_name) | Name of the Azure Web App. | `string` | n/a | yes |
| <a name="input_copilot_webapp_plan_name"></a> [copilot\_webapp\_plan\_name](#input\_copilot\_webapp\_plan\_name) | Name of the App Service Plan for the Web App. | `string` | n/a | yes |
