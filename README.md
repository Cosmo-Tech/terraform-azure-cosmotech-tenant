...
| <a name="input_adt_private_dns_zonename"></a> [adt\_private\_dns\_zonename](#input\_adt\_private\_dns\_zonename) | n/a | `string` | `"privatelink.digitaltwins.azure.net"` | no |
| <a name="input_argo_archive_ttl"></a> [argo\_archive\_ttl](#input\_argo\_archive\_ttl) | n/a | `string` | `"3d"` | no |
...
| <a name="input_argo_requeue_time"></a> [argo\_requeue\_time](#input\_argo\_requeue\_time) | n/a | `string` | `"1s"` | no |
| <a name="input_argo_service_account"></a> [argo\_service\_account](#input\_argo\_service\_account) | n/a | `string` | `""` | no |
| <a name="input_argo_version"></a> [argo\_version](#input\_argo\_version) | n/a | `string` | `"0.41.2"` | no |
| <a name="input_audience"></a> [audience](#input\_audience) | The App Registration audience type | `string` | `"AzureADMultipleOrgs"` | no |
| <a name="input_babylon_sp_client_id"></a> [babylon\_sp\_client\_id](#input\_babylon\_sp\_client\_id) | n/a | `string` | `""` | no |
| <a name="input_babylon_sp_client_secret"></a> [babylon\_sp\_client\_secret](#input\_babylon\_sp\_client\_secret) | n/a | `string` | `""` | no |
...
| <a name="input_blob_private_dns_zonename"></a> [blob\_private\_dns\_zonename](#input\_blob\_private\_dns\_zonename) | n/a | `string` | `"privatelink.blob.core.windows.net"` | no |
...
| <a name="input_container_admin_enabled"></a> [container\_admin\_enabled](#input\_container\_admin\_enabled) | n/a | `bool` | `true` | no |
| <a name="input_container_data_endpoint_enabled"></a> [container\_data\_endpoint\_enabled](#input\_container\_data\_endpoint\_enabled) | n/a | `bool` | `false` | no |
| <a name="input_container_public_network_access_enabled"></a> [container\_public\_network\_access\_enabled](#input\_container\_public\_network\_access\_enabled) | n/a | `bool` | `true` | no |
| <a name="input_container_quarantine_policy_enabled"></a> [container\_quarantine\_policy\_enabled](#input\_container\_quarantine\_policy\_enabled) | n/a | `bool` | `false` | no |
| <a name="input_container_retention_policy"></a> [container\_retention\_policy](#input\_container\_retention\_policy) | n/a | `number` | `7` | no |
| <a name="input_container_trust_policy"></a> [container\_trust\_policy](#input\_container\_trust\_policy) | n/a | `bool` | `false` | no |
| <a name="input_container_zone_redundancy_enabled"></a> [container\_zone\_redundancy\_enabled](#input\_container\_zone\_redundancy\_enabled) | n/a | `bool` | `false` | no |
| <a name="input_cosmosdb_access_key_metadata_writes_enabled"></a> [cosmosdb\_access\_key\_metadata\_writes\_enabled](#input\_cosmosdb\_access\_key\_metadata\_writes\_enabled) | n/a | `bool` | `true` | no |
| <a name="input_cosmosdb_analytical_storage_enabled"></a> [cosmosdb\_analytical\_storage\_enabled](#input\_cosmosdb\_analytical\_storage\_enabled) | n/a | `bool` | `false` | no |
| <a name="input_cosmosdb_backup_interval_in_minutes"></a> [cosmosdb\_backup\_interval\_in\_minutes](#input\_cosmosdb\_backup\_interval\_in\_minutes) | n/a | `number` | `240` | no |
| <a name="input_cosmosdb_backup_retention_in_hours"></a> [cosmosdb\_backup\_retention\_in\_hours](#input\_cosmosdb\_backup\_retention\_in\_hours) | n/a | `number` | `8` | no |
| <a name="input_cosmosdb_backup_storage_redundancy"></a> [cosmosdb\_backup\_storage\_redundancy](#input\_cosmosdb\_backup\_storage\_redundancy) | n/a | `string` | `"Geo"` | no |
| <a name="input_cosmosdb_backup_type"></a> [cosmosdb\_backup\_type](#input\_cosmosdb\_backup\_type) | n/a | `string` | `"Periodic"` | no |
| <a name="input_cosmosdb_consistency_interval_in_minutes"></a> [cosmosdb\_consistency\_interval\_in\_minutes](#input\_cosmosdb\_consistency\_interval\_in\_minutes) | n/a | `number` | `5` | no |
| <a name="input_cosmosdb_consistency_level"></a> [cosmosdb\_consistency\_level](#input\_cosmosdb\_consistency\_level) | n/a | `string` | `"Session"` | no |
| <a name="input_cosmosdb_consistency_max_staleness_prefix"></a> [cosmosdb\_consistency\_max\_staleness\_prefix](#input\_cosmosdb\_consistency\_max\_staleness\_prefix) | n/a | `number` | `100` | no |
| <a name="input_cosmosdb_failover_priority"></a> [cosmosdb\_failover\_priority](#input\_cosmosdb\_failover\_priority) | n/a | `number` | `0` | no |
| <a name="input_cosmosdb_is_virtual_network_filter_enabled"></a> [cosmosdb\_is\_virtual\_network\_filter\_enabled](#input\_cosmosdb\_is\_virtual\_network\_filter\_enabled) | n/a | `bool` | `false` | no |
| <a name="input_cosmosdb_network_acl_bypass_for_azure_services"></a> [cosmosdb\_network\_acl\_bypass\_for\_azure\_services](#input\_cosmosdb\_network\_acl\_bypass\_for\_azure\_services) | n/a | `bool` | `false` | no |
| <a name="input_cosmosdb_public_network_access_enabled"></a> [cosmosdb\_public\_network\_access\_enabled](#input\_cosmosdb\_public\_network\_access\_enabled) | n/a | `bool` | `true` | no |
...
| <a name="input_create_platform"></a> [create\_platform](#input\_create\_platform) | n/a | `string` | `true` | no |
...
| <a name="input_create_secrets"></a> [create\_secrets](#input\_create\_secrets) | Create secrets for newly created app registrations | `bool` | `false` | no |
...
| <a name="input_customertag"></a> [customertag](#input\_customertag) | n/a | `string` | `""` | no |
...
| <a name="input_eventhub_capacity"></a> [eventhub\_capacity](#input\_eventhub\_capacity) | n/a | `number` | `2` | no |
| <a name="input_eventhub_private_dns_zonename"></a> [eventhub\_private\_dns\_zonename](#input\_eventhub\_private\_dns\_zonename) | n/a | `string` | `"privatelink.servicebus.windows.net"` | no |
| <a name="input_eventhub_public_network_access_enabled"></a> [eventhub\_public\_network\_access\_enabled](#input\_eventhub\_public\_network\_access\_enabled) | n/a | `bool` | `true` | no |
...
| <a name="input_kusto_auto_stop"></a> [kusto\_auto\_stop](#input\_kusto\_auto\_stop) | Specifies if the cluster could be automatically stopped | `bool` | `false` | no |
| <a name="input_kusto_deploy"></a> [kusto\_deploy](#input\_kusto\_deploy) | Whether to create Azure digital explorer | `bool` | `true` | no |
| <a name="input_kusto_disk_encryption_enabled"></a> [kusto\_disk\_encryption\_enabled](#input\_kusto\_disk\_encryption\_enabled) | n/a | `bool` | `false` | no |
| <a name="input_kusto_double_encryption_enabled"></a> [kusto\_double\_encryption\_enabled](#input\_kusto\_double\_encryption\_enabled) | n/a | `bool` | `false` | no |
| <a name="input_kusto_engine"></a> [kusto\_engine](#input\_kusto\_engine) | n/a | `string` | `"V2"` | no |
...
| <a name="input_kusto_public_network_access_enabled"></a> [kusto\_public\_network\_access\_enabled](#input\_kusto\_public\_network\_access\_enabled) | n/a | `bool` | `true` | no |
| <a name="input_kusto_purge_enabled"></a> [kusto\_purge\_enabled](#input\_kusto\_purge\_enabled) | n/a | `bool` | `false` | no |
| <a name="input_kusto_streaming_ingestion_enabled"></a> [kusto\_streaming\_ingestion\_enabled](#input\_kusto\_streaming\_ingestion\_enabled) | n/a | `bool` | `true` | no |
| <a name="input_kusto_trusted_external_tenants"></a> [kusto\_trusted\_external\_tenants](#input\_kusto\_trusted\_external\_tenants) | n/a | `list(string)` | <pre>[<br>  "*"<br>]</pre> | no |
...
| <a name="input_network_dns_record_create"></a> [network\_dns\_record\_create](#input\_network\_dns\_record\_create) | Create the DNS record | `bool` | `false` | no |
| <a name="input_network_dns_zone_name"></a> [network\_dns\_zone\_name](#input\_network\_dns\_zone\_name) | The DNS zone name to create platform subdomain. Example: api.cosmotech.com | `string` | `"api.cosmotech.com"` | no |
...
| <a name="input_network_subnet_name"></a> [network\_subnet\_name](#input\_network\_subnet\_name) | Name of the subnet | `string` | `"default"` | no |
| <a name="input_network_tenant_address_prefix"></a> [network\_tenant\_address\_prefix](#input\_network\_tenant\_address\_prefix) | The Virtual Network IP range. Minimum /26 NetMaskLength | `string` | `"10.40.0.0/16"` | no |
| <a name="input_network_tenant_subnet_address_prefix"></a> [network\_tenant\_subnet\_address\_prefix](#input\_network\_tenant\_subnet\_address\_prefix) | n/a | `string` | `"10.40.0.0/24"` | no |
| <a name="input_platform_name"></a> [platform\_name](#input\_platform\_name) | The platform id for babylon v4 | `string` | `""` | no |
| <a name="input_platform_object_id"></a> [platform\_object\_id](#input\_platform\_object\_id) | n/a | `string` | `""` | no |
...
| <a name="input_publicip_create"></a> [publicip\_create](#input\_publicip\_create) | Create the public IP for the platform | `bool` | `false` | no |
| <a name="input_queue_private_dns_zonename"></a> [queue\_private\_dns\_zonename](#input\_queue\_private\_dns\_zonename) | n/a | `string` | `"privatelink.queue.core.windows.net"` | no |
...
| <a name="input_servlet_context_path"></a> [servlet\_context\_path](#input\_servlet\_context\_path) | ex: /cosmotech-api | `string` | `""` | no |
...
| <a name="input_storage_default_to_oauth_authentication"></a> [storage\_default\_to\_oauth\_authentication](#input\_storage\_default\_to\_oauth\_authentication) | n/a | `bool` | `false` | no |
| <a name="input_storage_enable_https_traffic_only"></a> [storage\_enable\_https\_traffic\_only](#input\_storage\_enable\_https\_traffic\_only) | n/a | `bool` | `true` | no |
| <a name="input_storage_kind"></a> [storage\_kind](#input\_storage\_kind) | n/a | `string` | `"StorageV2"` | no |
| <a name="input_storage_min_tls_version"></a> [storage\_min\_tls\_version](#input\_storage\_min\_tls\_version) | n/a | `string` | `"TLS1_2"` | no |
| <a name="input_storage_public_network_access_enabled"></a> [storage\_public\_network\_access\_enabled](#input\_storage\_public\_network\_access\_enabled) | n/a | `bool` | `false` | no |
| <a name="input_storage_shared_access_key_enabled"></a> [storage\_shared\_access\_key\_enabled](#input\_storage\_shared\_access\_key\_enabled) | n/a | `bool` | `true` | no |
| <a name="input_table_private_dns_zonename"></a> [table\_private\_dns\_zonename](#input\_table\_private\_dns\_zonename) | n/a | `string` | `"privatelink.table.core.windows.net"` | no |
...
| <a name="input_vault_token"></a> [vault\_token](#input\_vault\_token) | n/a | `string` | `""` | no |
