...
=======
| <a name="input_create_backup"></a> [create\_backup](#input\_create\_backup) | n/a | `bool` | n/a | yes |
>>>>>>> 60c1648 (terraform-docs: automated action)
...
| <a name="input_managed_disk_name"></a> [managed\_disk\_name](#input\_managed\_disk\_name) | n/a | `string` | n/a | yes |
...
| <a name="input_auto_stop_kusto"></a> [auto\_stop\_kusto](#input\_auto\_stop\_kusto) | Specifies if the cluster could be automatically stopped | `bool` | `false` | no |
...
| <a name="input_container_retention_policy"></a> [container\_retention\_policy](#input\_container\_retention\_policy) | n/a | <pre>list(object({<br>    days    = number<br>    enabled = bool<br>  }))</pre> | <pre>[<br>  {<br>    "days": 7,<br>    "enabled": false<br>  }<br>]</pre> | no |
| <a name="input_container_trust_policy"></a> [container\_trust\_policy](#input\_container\_trust\_policy) | n/a | <pre>list(object({<br>    enabled = bool<br>  }))</pre> | <pre>[<br>  {<br>    "enabled": false<br>  }<br>]</pre> | no |
...
| <a name="input_create_platform_config"></a> [create\_platform\_config](#input\_create\_platform\_config) | Whether to create platform config secret | `bool` | `false` | no |
...
| <a name="input_subnet_name"></a> [subnet\_name](#input\_subnet\_name) | Name of the subnet | `string` | `"default"` | no |
