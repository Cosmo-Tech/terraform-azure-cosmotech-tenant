...
| <a name="input_tenant_client_id"></a> [tenant\_client\_id](#input\_tenant\_client\_id) | n/a | `string` | n/a | yes |
| <a name="input_tenant_client_secret"></a> [tenant\_client\_secret](#input\_tenant\_client\_secret) | n/a | `string` | n/a | yes |
...
| <a name="input_tls_certificate_custom_certificate_path"></a> [tls\_certificate\_custom\_certificate\_path](#input\_tls\_certificate\_custom\_certificate\_path) | n/a | `string` | `""` | no |
| <a name="input_tls_certificate_custom_key_path"></a> [tls\_certificate\_custom\_key\_path](#input\_tls\_certificate\_custom\_key\_path) | n/a | `string` | `""` | no |
